            ...
            <div class="invoice-header">
                <div class="invoice-from">
                    ...
                    <address class="m-t-5 m-b-5">
                        <strong class="text-inverse">MyDana, Luxury Hotel.</strong><br>
                        Street Address<br>
                        City, Zip Code<br>
                ...
                <div class="invoice-to">
                    <small>to</small>
                    <form:form modelAttribute="guest" method="get">
                        <address class="m-t-5 m-b-5">
                            ${guest.full_name}<br/>
                            ${guest.email}<br>
                            ${guest.address}<br>
            ...
            <div class="invoice-content">
                ...
                <div class="table-responsive">
                    <table class="table table-invoice">
                        <thead>
                        <tr>
                            <th class="text-left">Category Room</th>
                            <th class="text-center" width="15%">People</th>
                            <th class="text-center" width="15%">Room</th>
                            <th class="text-center" width="15%">Price/Day</th>
                            <th class="text-center" width="15%">Services</th>
